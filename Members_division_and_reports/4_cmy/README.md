...
本系统为`CMS`系统，基于免费开源的 `PbootCMS` 模板，主要实现以下功能：
...
> | formcheck | true | string | 身份验证标志 |

###### 返回字段

> | 返回字段 | 字段类型 | 说明                                     |
> | :------- | :------- | :--------------------------------------- |
> | code     | int      | 返回结果状态。1：登录成功；0：登录失败。 |
...
1.在pbootcms下载安装环境配置中，开始使用的是php 5.2.17，不能正常打开网页，如下图所示：

![php_study_error418](../img/php_study_error418.png)

根据提示切换php版本为7.2.10后即可成功打开

![php_study_error1_419](../img/php_study_error1_419.jpg)
