	...
	<div class="layui-tab layui-tab-brief" lay-filter="tab">
	  ...
	  <div class="layui-tab-content">
	  	   <div class="layui-tab-item layui-show">
	  	   		<form action="<?php echo URL;?>" method="post" class="layui-form">
	  	   			<input type="hidden" name="formcheck" value="<?php echo $this->getVar('formcheck');?>" > 
	  	   			<div class="layui-form-item">
	                     <label class="layui-form-label">用户账号</label>
	                     <div class="layui-input-block">
	                     	<input type="text" name="username" required  lay-verify="required" value="<?php echo session('username');?>" placeholder="请输入用户账号" class="layui-input">
	                     </div>
	                </div>
	                ...
	                <div class="layui-form-item">
	                     ...
	                     <div class="layui-input-block">
	                     	<input type="text" name="realname" value="<?php echo session('realname');?>"  placeholder="请输入真实姓名" class="layui-input">
	                     </div>
	                </div>
