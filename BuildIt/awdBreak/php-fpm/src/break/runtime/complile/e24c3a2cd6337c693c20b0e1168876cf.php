	    ...
	    <li  lay-id="t7">URL规则</li>
		  ...
		  <div class="layui-tab-content">
		  	   ...
		  	   <div class="layui-tab-item">
		                ...
		                <div class="layui-form-item">
		                     <label class="layui-form-label">普通推送token</label>
		                     <div class="layui-input-inline">
		                     	<input type="text" name="baidu_zz_token"  value="<?php echo @$this->vars['configs']['baidu_zz_token']['value'];?>" placeholder="请输入百度普通推送token"  class="layui-input">
		                     </div>
		                     <span class="layui-icon layui-icon-about tips" data-content="请到百度站长中心的链接提交栏目中获取！"></span>
		                </div>
		               ...
		               <div class="layui-form-item">
		                     ...
		                     <div class="layui-input-inline">
		                     	<input type="text" name="baidu_xzh_appid"  value="<?php echo @$this->vars['configs']['baidu_xzh_appid']['value'];?>" placeholder="请输入百度熊掌号appid"  class="layui-input">
		                     </div>
		               </div>
		               ...
		               <div class="layui-form-item">
		                     ...
		                     <div class="layui-input-inline">
		                     	<input type="text" name="baidu_xzh_token"  value="<?php echo @$this->vars['configs']['baidu_xzh_token']['value'];?>" placeholder="请输入百度熊掌号token"  class="layui-input">
		                     </div>
		               </div>
		               
		               <div class="layui-form-item">
		                     <label class="layui-form-label">熊掌号推送类型</label>
		                     <div class="layui-input-block">
		                     	<input type="radio" name="baidu_xzh_type" value="0" <?php if ($this->vars['configs']['baidu_xzh_type']['value']==0) {?> checked="checked" <?php } ?> title="天级">
								<input type="radio" name="baidu_xzh_type" value="1" <?php if ($this->vars['configs']['baidu_xzh_type']['value']==1) {?> checked="checked" <?php } ?> title="周级">
		                     </div>
		               </div>
		  	   ...
		  	   <div class="layui-tab-item">
		  	    ...
		  	    <div class="layui-tab-item">
		                ...
		                <div class="layui-form-item">
		                     <label class="layui-form-label">登录失败阀值</label>
		                     <div class="layui-input-inline">
								<input type="text" name="lock_count" value="<?php echo @$this->vars['configs']['lock_count']['value'];?>" placeholder="请输入登录失败几次后锁定IP，默认5次" class="layui-input">
		                     </div>
		                     <div class="layui-form-mid layui-word-aux">次</div>
		                </div>
		                ...
		                <div class="layui-form-item">
		                   ...
		                   <div class="layui-input-inline">
		                  		<input type="text" name="lock_time" value="<?php echo @$this->vars['configs']['lock_time']['value'];?>" placeholder="请输入登录异常锁定时间，默认为900秒" class="layui-input">
		                   </div>
		                   <div class="layui-form-mid layui-word-aux">秒</div>
			            </div>
