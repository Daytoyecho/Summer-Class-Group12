	                        ...
	                        <td>
	                            ...
	                            <?php if (check_level('mod')) {?>
	                            	...
	                            	<?php if ($this->getVar('baidu_zz_token') && !$value->outlink) {?>
	                            		<a href="<?php echo \core\basic\Url::get('/admin/'.C.'/mod/baiduzz/'.$value->id.'');?>" class="layui-btn layui-btn-xs layui-btn-primary" >百度推送</a>
	                            	<?php } ?>
	                            	<?php if ($this->getVar('baidu_xzh_appid') && !$value->outlink) {?>
	                            		<a href="<?php echo \core\basic\Url::get('/admin/'.C.'/mod/baiduxzh/'.$value->id.'');?>" class="layui-btn layui-btn-xs layui-btn-primary" >熊掌号推送</a>
	                            	<?php } ?>
	                            <?php } ?>
	                        </td>
	                    </tr>
...
<?php return array (
  ...
  1 => '/Applications/XAMPP/xamppfiles/htdocs/pc/apps/admin/view/default/common/ueditor.html',
  2 => '/Applications/XAMPP/xamppfiles/htdocs/pc/apps/admin/view/default/common/foot.html',
); ?>